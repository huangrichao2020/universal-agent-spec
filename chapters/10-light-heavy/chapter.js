  ...
  window.AgentSpec.register({
    ...
    getSvg(lang) {
      return `
        ...
        <!-- 90% code sector (large, blue) -->
        <path d="M200,124 L200,30 A94,94 0 1,1 107.1,171 Z" fill="#0050a0" opacity="0.85"/>
        <!-- 10% AI sector (small, amber) -->
        <path d="M200,124 L107.1,171 A94,94 0 0,1 200,30 Z" fill="#92400e" opacity="0.85"/>
        <text x="200" y="108" text-anchor="middle" fill="#ffffff"
          font-family="'JetBrains Mono',monospace" font-size="26" font-weight="700">90%</text>
        <text x="200" y="126" text-anchor="middle" fill="#ffffffcc"
          font-family="'JetBrains Mono',monospace" font-size="11">
          ${t(lang, 'Code logic', '代码逻辑')}
        </text>
        <text x="148" y="174" text-anchor="middle" fill="#ffffff"
          font-family="'JetBrains Mono',monospace" font-size="15" font-weight="700">10%</text>
        <text x="148" y="188" text-anchor="middle" fill="#ffffffcc"
        ...
        <!-- 10% code sector (small, blue) -->
        <path d="M560,124 L560,30 A94,94 0 0,1 608.4,210 Z" fill="#0050a0" opacity="0.85"/>
        <!-- 90% AI sector (large, purple) -->
        <path d="M560,124 L608.4,210 A94,94 0 1,1 560,30 Z" fill="#5b21b6" opacity="0.85"/>
        <text x="560" y="144" text-anchor="middle" fill="#ffffff"
          font-family="'JetBrains Mono',monospace" font-size="26" font-weight="700">90%</text>
        <text x="560" y="162" text-anchor="middle" fill="#ffffffcc"
          font-family="'JetBrains Mono',monospace" font-size="11">
          ${t(lang, 'Agent interaction', 'Agent 交互')}
        </text>
        <text x="600" y="80" text-anchor="middle" fill="#ffffff"
          font-family="'JetBrains Mono',monospace" font-size="15" font-weight="700">10%</text>
        <text x="600" y="94" text-anchor="middle" fill="#ffffffcc"
          font-family="'JetBrains Mono',monospace" font-size="9">
          ${t(lang, 'UI', 'UI+运行')}
        </text>
